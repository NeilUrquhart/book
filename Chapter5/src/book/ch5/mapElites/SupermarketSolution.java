...
public class SupermarketSolution extends EliteSolution{
	...
	public double getCostDel() {
		return SupermarketCostModel.getInstance().getSolutionCost(this)/((VRPTWProblem)this.problem).getTotalDemand();
	}
	...
	protected void decode() {
		if (phenotype == null) {
			...
			VRPTWModalRoute newRoute = new VRPTWModalRoute(((VRPTWProblem)this.problem));
			...
			for (Gene tmp : genotype){
				...
				if (addNewRoute) {
					...
					newRoute = new VRPTWModalRoute(((VRPTWProblem)this.problem));
