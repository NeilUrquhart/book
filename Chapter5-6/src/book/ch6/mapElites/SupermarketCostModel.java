...
public class SupermarketCostModel {
	/*
	 * Neil Urquhart 2021
	...
	//Singleton code
	private static  SupermarketCostModel instance=null;

	public static SupermarketCostModel getInstance() {
		if (instance == null)
			instance = new SupermarketCostModel();
		return instance;
	}
	//Done Singleton
	...
	public int getCycles(MObjTWIndividual i) {
	...
	public int getVans(MObjTWIndividual i) {
	...
	public double getEmissions(MObjTWIndividual i) {
	...
	public double getCycleDels(MObjTWIndividual i) {
	...
	public double getCycleDist(MObjTWIndividual i) {
